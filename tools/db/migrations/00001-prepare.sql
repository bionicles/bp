...
create policy app.users.public_display_names_and_abstract on app.users 
...
create index app.users.abstract_index on app.users (lower(abstract))
...
create policy app.teams.public_display_names_and_abstract on app.teams
...
create index app.teams.abstract_index on app.teams (lower(abstract))
